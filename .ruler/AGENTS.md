...
- **Quality gates before committing**:
  - MUST pass: `npx nx affected -t lint,typecheck`
  - MUST pass: `npx nx affected -t test` (unit tests for packages)
  - E2E tests deferred until POC validated
- For broader changes, consider `npx nx affected -t lint,typecheck,test,build`
